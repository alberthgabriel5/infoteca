<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManEditarNoticia.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManEditarNoticia"  MasterPageFile="~/MasterPage.Master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="container">
    ...
    <li class="active"><a href="#home">Actualizar</a></li>
          ...
          <h3>Actualizar</h3>
            ...
            <div class="form-row">
                ...
                <label for="AjaxFileUpload1">Imagenes:</label>
                    <asp:AjaxFileUpload ID="AjaxFileUpload1" runat="server" onuploadcomplete="AjaxFileUpload1_UploadComplete" ThrobberID="myThrobber"  MaximumNumberOfFiles="50" AllowedFileTypes="jpg,jpeg" OnClientUploadComplete="ajaxFileUploadAttachments_ClientUploadComplete"/>
                </div> 
            </div>
            <div class="form-row">
                <div class="form-group col-md-4 ">
                    <label for="DropDownListImagenes">Imagenes Registradas:</label>
                    <asp:UpdatePanel ID="updatePanelAttachments" runat="server" OnLoad="updatePanelAttachments_Load" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList runat="server" ID="DropDownListImagenes" class="form-control" Enabled="False">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <br/>
                ...
                <div class="form-group col-md-4 ">
                    ...
                    <asp:Button type="submit" class="btn btn-info" runat="server" ID="Button14" OnClick="VerImagen" Text="Ver Imagen" Visible="False"></asp:Button>
                    <asp:Button type="submit" class="btn btn-danger" runat="server" ID="Button15" OnClick="BorrarImagenMostrarAlerta" Text="Borrar Imagen" Visible="False"></asp:Button>
                </div>
            </div>
            <div class="form-group col-md-12">
                <asp:Button type="submit" class="btn btn-primary" runat="server" ID="editar" OnClick="Editar_Noticia" Text="Actualizar Noticia"></asp:Button> 
    ...
    <!-- Modal -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" runat="server">
                        <asp:Literal runat="server" ID="TituloImagen"></asp:Literal>
                    </h4>
                </div>
                <div class="modal-body">
                    <p><asp:Image runat="server" ID="Imagen" Width="550"/></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><asp:Literal runat="server" ID="BorrarImagenMensaje"></asp:Literal></p>
                </div>
                <div class="modal-footer">
                    <asp:Button runat="server" class="btn btn-primary" EnableViewState="True" Text="Si" OnClick="BorrarImagen"/>
    ...
    <script type="text/javascript">
        ...
        function AjaxFileUpload_change_text() {
            ...
            Sys.Extended.UI.Resources.AjaxFileUpload_DropFiles = "Soltar archivos aquí";
    ...
    <script language="javascript" type="text/javascript">
        function ajaxFileUploadAttachments_ClientUploadComplete(sender, e) {
            if (sender._filesInQueue[sender._filesInQueue.length - 1]._isUploaded)
                __doPostBack('updatePanelAttachments', ''); 
        }
    </script>
</asp:Content>
