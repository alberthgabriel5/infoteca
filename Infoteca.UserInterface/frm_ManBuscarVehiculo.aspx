<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManBuscarVehiculo.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManBuscarVehiculo"  MasterPageFile="~/MasterPage.Master"%>
        ...
        <div class="table-wrapper-scroll-y">
            <asp:GridView ID="gvPerson" runat="server" AutoGenerateColumns = "False" 
                ...
                <Columns> 
                    ...
                    <asp:TemplateField HeaderText="Placa" SortExpression="LstrPlaca"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("LstrPlaca") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Marca" SortExpression="LstrMarca"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("LstrMarca") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Modelo" SortExpression="LstrModelo"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("LstrModelo") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Color" SortExpression="LstrColor"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label4" runat="server" Text='<%# Bind("LstrColor") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Estilo" SortExpression="LstrEstilo"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("LstrEstilo") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button runat="server" class="btn btn-primary" OnClick="BorrarVehiculo" EnableViewState="True" Text="Si"/>
