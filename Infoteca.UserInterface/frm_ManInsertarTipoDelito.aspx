<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManInsertarTipoDelito.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManInsertarTipoDelito"  MasterPageFile="~/MasterPage.Master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">       
    ...
    <div class="form-group col-md-12">
      <h2>Registro de Tipos de Delito</h2>    
    </div>    
  </div>
  <div class="form-row">
        ...
        <div class="form-group col-md-12">
          <asp:Button ID="btn_registrar" type="submit" class="btn btn-success" runat="server" OnClick="RegistrarTipoDelito" Text="Registrar" EnableViewState="True"/> 
