<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManInsertarPersona.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManInsertarPersona"  MasterPageFile="~/MasterPage.Master"%>
...
<div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
          <asp:Button ID="btn_registrar" type="submit" class="btn btn-success" runat="server" OnClick="RegistrarPersona" Text="Registrar" EnableViewState="True"/> 
