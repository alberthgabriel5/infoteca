<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ConReporteEstado.aspx.cs" Inherits="Infoteca.UserInterface.frm_ConReporteEstado" MasterPageFile="~/MasterPage.Master" %>
    ...
    <div class="container">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                <asp:LinkButton  class="btn btn-primary" id="BtnGenerarPDF" runat="server" OnClick="GenerarPDF_OnClick">Exportar a PDF <i aria-hidden="true" class="glyphicon glyphicon-export"></i></asp:LinkButton>
            </div>
        </div>
        <div class="form-row">
