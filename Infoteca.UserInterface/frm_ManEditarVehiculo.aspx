<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManEditarVehiculo.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManEditarVehiculo"  MasterPageFile="~/MasterPage.Master"%>
...
<div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
          <asp:Button ID="btn_registrar" type="submit" class="btn btn-success" runat="server" OnClick="ActualizarVehiculo" Text="Actualizar" EnableViewState="True"/> 
            <asp:LinkButton runat="server" ID="volver" PostBackUrl="frm_ManBuscarVehiculo.aspx" Text="Volver" CssClass="btn btn-primary"></asp:LinkButton>
        </div>
