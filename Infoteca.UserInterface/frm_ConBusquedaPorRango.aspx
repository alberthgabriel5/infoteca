<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="frm_ConBusquedaPorRango.aspx.cs" Inherits="Infoteca.UserInterface.frm_ConBusquedaPorRango" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">    

    <div class="container">
    <h2>Busqueda por Rango de Fechas</h2>
    <hr />
    <div class="form-row">
