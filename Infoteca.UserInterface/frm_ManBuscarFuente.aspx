<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManBuscarFuente.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManBuscarFuente"  MasterPageFile="~/MasterPage.Master"%>
        ...
        <div class="table-wrapper-scroll-y">
            <asp:GridView ID="gvPerson" runat="server" AutoGenerateColumns = "False" 
                ...
                <Columns> 
                    ...
                    <asp:TemplateField HeaderText="Tipo Identificación" SortExpression="LstrNombreFuente"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("LstrNombreFuente") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Identificación" SortExpression="LstrTitulo"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("LstrTitulo") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Nombre" SortExpression="LstrSubTitulo"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("LstrSubTitulo") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Alias" SortExpression="LstrNombre"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("LobjTipoFuente.LstrNombre") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button runat="server" class="btn btn-primary" OnClick="BorrarFuente" EnableViewState="True" Text="Si"/>
