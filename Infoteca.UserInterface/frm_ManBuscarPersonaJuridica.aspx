<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManBuscarPersonaJuridicaJuridica.aspx.cs" Inherits="Infoteca.UserInterface.frm_ManBuscarPersonaJuridica"  MasterPageFile="~/MasterPage.Master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="server">       
    ...
    <div class="form-group col-md-12">
      <h2>PersonaJuridicas Registradas</h2>    
    </div>    
  </div>
        ...
        <div class="table-wrapper-scroll-y">
            <asp:GridView ID="gvPerson" runat="server" AutoGenerateColumns = "False" 
                ...
                <Columns> 
                    ...
                    <asp:TemplateField HeaderText="Cédula Jurídica" SortExpression="LstrCedulaJuridica"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("LstrCedulaJuridica") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Nombre Jurídico" SortExpression="LstrNombreJuridico"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("LstrNombreJuridico") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Nombre Público" SortExpression="LstrNombrePublico"> 
                        <ItemTemplate> 
                            <asp:Label ID="Label4" runat="server" Text='<%# Bind("LstrNombrePublico") %>'></asp:Label> 
                        </ItemTemplate> 
                    </asp:TemplateField>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Borrar PersonaJuridica</h4>
                </div>
                <div class="modal-body">
                    <p><asp:Literal runat="server" ID="borrarMensaje"></asp:Literal></p>
                </div>
                <div class="modal-footer">
                    <asp:Button runat="server" class="btn btn-primary" OnClick="BorrarPersonaJuridica" EnableViewState="True" Text="Si"/>
